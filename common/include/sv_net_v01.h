...
input -> tag10-> cbp9_blk -> sv_res_77 [dtago1] ----------------------> [dtagi1] cbp3_blk -> sv_res_33 -> prelu -> bn_con -> con3(N) -> output
                                ...
                                con2d                                             cont2u
                                   \                                               /
                                 sv_res_33 [dtago2] ---------------> [dtagi2] sv_res_33
                                     \                                           /
                                    con2d                                     cont2u
                                       \                                       /
                                        -------------> sv_res_33 ------------> 
...
template <int N1, int N2, typename SUBNET> using sv_block_37 = con3<N1, dlib::prelu<dlib::bn_con<con7<N2, SUBNET>>>>;

template <int N1, int N2, typename SUBNET> using sv_block_53 = con5<N1, dlib::prelu<dlib::bn_con<con3<N2, SUBNET>>>>;
template <int N1, int N2, typename SUBNET> using sv_block_55 = con5<N1, dlib::prelu<dlib::bn_con<con5<N2, SUBNET>>>>;
template <int N1, int N2, typename SUBNET> using sv_block_57 = con5<N1, dlib::prelu<dlib::bn_con<con7<N2, SUBNET>>>>;

template <int N1, int N2, typename SUBNET> using sv_block_73 = con7<N1, dlib::prelu<dlib::bn_con<con3<N2, SUBNET>>>>;
template <int N1, int N2, typename SUBNET> using sv_block_75 = con7<N1, dlib::prelu<dlib::bn_con<con5<N2, SUBNET>>>>;
template <int N1, int N2, typename SUBNET> using sv_block_77 = con7<N1, dlib::prelu<dlib::bn_con<con7<N2, SUBNET>>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_33 = dlib::add_prev1<sv_block_33<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_35 = dlib::add_prev1<sv_block_35<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_37 = dlib::add_prev1<sv_block_37<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_53 = dlib::add_prev1<sv_block_53<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_55 = dlib::add_prev1<sv_block_55<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_57 = dlib::add_prev1<sv_block_57<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using sv_res_77 = dlib::add_prev1<sv_block_77<N1,N2, dlib::tag1<SUBNET>>>;
...
template <int N1, int N2, typename SUBNET> using asv_block_77 = con7<N1, dlib::prelu<dlib::affine<con7<N2, SUBNET>>>>;

template <int N1,int N2,typename SUBNET>
using asv_res_33 = dlib::add_prev1<asv_block_33<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using asv_res_55 = dlib::add_prev1<asv_block_55<N1,N2, dlib::tag1<SUBNET>>>;

template <int N1,int N2,typename SUBNET>
using asv_res_77 = dlib::add_prev1<asv_block_77<N1,N2, dlib::tag1<SUBNET>>>;
...
// ----------------------------------------------------------------------------------------
using sv_net_type = dlib::loss_multiclass_log_per_pixel<
    con3<256, dlib::prelu<dlib::bn_con<sv_res_33<256, 256, cbp3_blk<256,

    dlib::concat2<dtago1, dtagi1,
    dtagi1<cont2u<256, sv_res_33<512, 512, cbp3_blk<512,

    dlib::concat2<dtago2, dtagi2,
    dtagi2<cont2u<512, sv_res_33<1024, 1024, con2d<1024,
...
// ----------------------------------------------------------------------------------------
using asv_net_type = dlib::loss_multiclass_log_per_pixel<
    con3<256, dlib::prelu<dlib::affine<asv_res_33<256, 256, acbp3_blk<256,

    dlib::concat2<dtago1, dtagi1,
    dtagi1<cont2u<256, asv_res_33<512,512,acbp3_blk<512,

    dlib::concat2<dtago2, dtagi2,
    dtagi2<cont2u<512, asv_res_33<1024,1024,con2d<1024,
...
{
    net_type net(dlib::num_con_outputs(1),
...
template<typename net_type>
void save_gorgon(net_type &sv_net, uint64_t one_step_calls)
{
    //gc_01.save_params(sv_net, one_step_calls);
    //gc_02.save_params(sv_net, one_step_calls);
    //gc_03.save_params(sv_net, one_step_calls);
    //gc_04.save_params(sv_net, one_step_calls);
    //gc_05.save_params(sv_net, one_step_calls);
    //gc_06.save_params(sv_net, one_step_calls);
    //gc_07.save_params(sv_net, one_step_calls);
    //gc_08.save_params(sv_net, one_step_calls);
    //gc_09.save_params(sv_net, one_step_calls);
    //gc_10.save_params(sv_net, one_step_calls);
    //gc_11.save_params(sv_net, one_step_calls);
    //gc_12.save_params(sv_net, one_step_calls);
    //gc_13.save_params(sv_net, one_step_calls);
    //gc_14.save_params(sv_net, one_step_calls);
    //gc_15.save_params(sv_net, one_step_calls);
}
